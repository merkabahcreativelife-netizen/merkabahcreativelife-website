...
export default function JournalArticle() {
  ...
  if (!a) return <div className="pt-32 pb-24 text-center text-ink-mute">Article not found.</div>;
  return (
    <article className="pb-24">
      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-8 -mt-24 relative">
        ...
        <h1 className="font-display font-light text-4xl sm:text-5xl lg:text-6xl leading-[1] tracking-tighter text-ink mt-4">{a.title}</h1>
        <div className="mt-6 text-sm text-ink-mute">By {a.author || "Merkabah Editorial"} · {a.created_at?.slice(0, 10)}</div>
