  ...
  return (
    <>
      <section className="relative min-h-[80vh] flex items-end overflow-hidden pb-20">
        <img src={ins.img} alt="" className="absolute inset-0 w-full h-full object-cover opacity-70" />
        ...
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          ...
          {done ? (
            <div data-testid="trial-success" className="border border-terracotta-500/40 p-10">
              <div className="font-display text-2xl text-ink mb-3">Thank you.</div>
              <p className="text-ink-soft">We've received your trial class request and will reach out shortly to confirm your time slot.</p>
            </div>
          ) : (
