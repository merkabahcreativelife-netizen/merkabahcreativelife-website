    ...
    <>
      <section className="relative min-h-[70vh] flex items-end overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 w-full">
          ...
          <h1 className="font-display font-light text-5xl sm:text-7xl lg:text-8xl leading-[0.95] tracking-tighter text-cream-50 mt-6">
            A journey of creation, discovery & transformation.
          </h1>
        </div>
      </section>

      <section className="py-24 lg:py-32 max-w-4xl mx-auto px-6 lg:px-8 space-y-8 text-stone-300 text-lg leading-relaxed">
        ...
        <p>Our name, <em className="text-cream-50">Merkabah</em>, symbolizes spiritual ascent and represents our commitment to growth, creativity and transformation.</p>
      ...
      <section className="py-24 border-y border-stone-900 bg-stone-900/30">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <h2 className="font-display text-4xl lg:text-6xl text-cream-50 font-light leading-tight tracking-tight max-w-3xl">
            Ascend. Create. Discover. Transform.
          </h2>
          <p className="mt-8 text-stone-300 max-w-2xl text-lg leading-relaxed">
      ...
      <section className="py-24 lg:py-32 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <h2 className="font-display text-4xl lg:text-6xl text-cream-50 font-light tracking-tight max-w-3xl leading-[1.05]">
      ...
      <section className="py-24 border-t border-stone-900 grid md:grid-cols-2 gap-12 max-w-7xl mx-auto px-6 lg:px-8">
        <div>
          <div className="overline mb-4">Vision</div>
          <p className="font-display text-2xl lg:text-3xl text-cream-50 leading-snug">
      ...
      <section className="bg-stone-900/50 border-t border-stone-900">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-12 py-24">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 text-stone-300 text-lg leading-relaxed">Founder & Creative Visionary — a unique fusion of media, music, sound engineering and creative expression.</p>
            <Link to="/founder" data-testid="about-meet-founder" className="mt-8 self-start bg-terracotta-500 hover:bg-terracotta-600 text-cream-50 px-8 py-4 text-xs uppercase tracking-[0.25em] transition-colors">Read His Story</Link>
          </div>
        </div>
      </section>
    </>
