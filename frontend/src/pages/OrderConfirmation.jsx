...
export default function OrderConfirmation() {
  ...
  return (
    <section className="pt-24 pb-24 max-w-3xl mx-auto px-6 lg:px-8 text-center">
      ...
      <div className="mt-12 border border-silver-200 p-8 text-left">
        ...
        <div className="mt-4 pt-4 border-t border-silver-200 flex justify-between font-display text-2xl text-ink"><span>Total</span><span>₹{order.total}</span></div>
