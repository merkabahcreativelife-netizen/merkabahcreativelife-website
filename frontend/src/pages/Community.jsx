...
export default function Community() {
  ...
  return (
    <section className="pt-24 pb-24 max-w-4xl mx-auto px-6 lg:px-8">
      ...
      <h1 className="font-display font-light text-5xl sm:text-7xl leading-[0.95] tracking-tighter text-ink mt-4">There's a place for you in the Merkabah journey.</h1>
